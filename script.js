...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.skill-card, .education-card, .hobby-item, .detail-item, .contact-item');
...
// Add active state for scroll to top button
